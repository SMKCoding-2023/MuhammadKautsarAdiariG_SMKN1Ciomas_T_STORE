...
<template>
  <div class="w-full max-w-sm p-4 bg-white rounded-lg shadow-[0_30px_60px_rgba(0,0,0,0.15)] sm:p-6 md:p-8">
    <form class="" @submit.prevent="submitLogin">
      <div class="mb-6">
        <h5 class="text-2xl font-medium text-green-700 mb-2">Login</h5>
        <span class="text-sm font-normal text-gray-600">Sign in to continue to our application</span>
      </div>
      ...
      <button type="submit" class="w-full flex justify-center items-center text-white bg-blue-700 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6">
