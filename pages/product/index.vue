...
<NuxtLink to="/product/create" class="bg-green-500 hover:bg-green-400 text-white flex justify-center items-center px-3 py-3 rounded-lg">Create Products</NuxtLink>
</div>
